      ...
      <div className="boxHolder" data-aos="fade-up" data-aos-duration="3000">
        <section>
          ...
          <div className="textArea">
            <div className="iconHolder"><PiStudentDuotone size={50} color='#003B31'/></div>
            <div className="calc">
              <span>students</span>
              <h3>0</h3>
            </div>
        ...
        <div className="color"></div>
          <div className="textArea">
            <div className="iconHolder"><BsPersonRolodex color=' #F4B400' size={50} />
            </div>
            <div className="calc">
              <span>Teachers</span>
              <h3>0</h3>
      ...
      <div className="AnnouncementBox">
        <div className='AnnounceArticle'>
          <div className="articleHeading">
            ...
            <textarea placeholder='What would like to announce today?'></textarea>
        </div>
